...
class World(object):
    def __init__(self, carla_world, hud, args, client=None):
    ...
    def spawn_pedestrians(self, n_pedestrians):
        ...
        for i in range(0, len(self.controllers)):
            ...
            print(self.controllers[i].get_location())
...
def game_loop(args):
    ...
    try:
        ...
        world = World(sim_world, hud, args, client=client)
