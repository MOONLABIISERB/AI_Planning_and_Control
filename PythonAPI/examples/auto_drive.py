...
class World(object):
    ...
    def __init__(self, carla_world, hud, args, vehicle_name=VEHICLE_NAME, client=None, respwan_peds=True, big_cam=False, display2=None):
        """Constructor method"""
        self._args = args
    ...
    def restart(self, args):
        ...
        peds, ped_controllers = self.spawn_pedestrians(self._args.n_pedestrians)
        ## SETUP SENORS
        ...
        map_utils.init(self.client, self.world, self.map, self.player, self.display2)
...
#         self._target_pose = self.map.get_spawn_points()[1]

#         self._local_planner = LocalPlannerNew(self.player, 2.5, 9.0, 1.5)
...
#         self.command = self._local_planner.checkpoint[1].value
...
def main():
    ...
    argparser.add_argument(
        ...
        default='/media/storage/karthik/lbc/checkpoints/phase1/model-700.th')
    argparser.add_argument(
        '--town',
